...
| 2 | Game Engine (X01/Cricket/practice, undo, bidir WS) | ▶ in progress |
| 3 | Desktop UI (React+TS+Tailwind+Zustand web app; Tauri config scaffolded) | ⏳ |
...
- SP2: spec committed (00416ff); writing plan next.
